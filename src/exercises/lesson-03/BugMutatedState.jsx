...
// Explanation:
// I removed count++ because it directly mutates count. State should be treated immutable
// Change to a const
// Using setCount(count => count + 1) react recieves a new reference and triggers a re-render
